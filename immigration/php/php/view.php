...
<body>
<div id="wrapper">
<a class="home" href="../ordering.html">Plaza Indian Trading Post</a><br /><br />
<h2>Shopping Cart</h2>
<table class="ztable" width="400px">
<tr>
	<th>Description</th><th>Quantity</th><th>Price</th></tr>
<tr bgcolor='#FFFFFF'>
	<td><?php echo htmlspecialchars ($_POST['desc1']); ?></td>
	<td align='center'>  </td>
	<td><?php echo htmlspecialchars ($_POST['cost1']); ?></td>
</tr>
<tr bgcolor='#FFFFFF'>
	<td><?php echo htmlspecialchars ($_POST['desc2']); ?></td>
	<td align='center'>  </td>
	<td><?php echo htmlspecialchars ($_POST['cost2']); ?></td>
</tr>
<tr bgcolor='#FFFFFF'>
	<td><?php echo htmlspecialchars ($_POST['desc3']); ?></td>
	<td align='center'>  </td>
	<td><?php echo htmlspecialchars ($_POST['cost3']); ?></td>
</tr>
<tr bgcolor='#FFFFFF'>
	<td><?php echo htmlspecialchars ($_POST['desc4']); ?></td>
	<td align='center'>  </td>
	<td><?php echo htmlspecialchars ($_POST['cost4']); ?></td>
</tr>
<tr>
	<td></td>
	<td bgcolor='#CCCCCC'><strong>Total</strong></td>
	<td bgcolor='#CCCCCC'><?php echo htmlspecialchars ($_POST['cost1']); ?></td>
</tr>
</table>
