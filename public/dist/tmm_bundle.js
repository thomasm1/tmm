...
angular.module('app').component('posts', {
          bindings: { app: '<' },
          template: '<h3>August:</h3>' + '<ul>' + '  <li ng-repeat="post in $ctrl.posts">' + '    <a ui-sref="post({ postId: post.id })">' + '      {{post.name}}' + '    </a>' + '  </li>' + '</ul>'
...
(function () {
    ...
    angular.module('app').controller('AllSchoolsController', ['dataService', 'notifier', AllSchoolsController]);
...
(function () {
    ...
    angular.module('app').controller('AllClassroomsController', ['dataService', 'notifier', AllClassroomsController]);
...
(function () {
    ...
    angular.module('app').controller('AllActivitiesController', ['dataService', 'notifier', '$state', 'activities', '$log', AllActivitiesController]);
    ...
    function AllActivitiesController(dataService, notifier, $state, activities, $log) {
        ...
        dataService.getAllActivities().then(function (activities) {
            vm.allActivities = activities;
        }).catch(showError);
...
(function () {
    ...
    angular.module('app').controller('ClassroomController', ['dataService', 'notifier', '$stateParams', 'classroom', ClassroomController]);
...
(function () {
    ...
    angular.module('app').controller('ClassroomSummaryController', ['classroom', ClassroomSummaryController]);
...
(function () {
    ...
    angular.module('app').controller('ClassroomMessageController', ['$stateParams', ClassroomMessageController]);
...
(function () {
   ...
   angular.module('app').controller('dataViz', [dataViz]);
   ...
   function dataViz() {
      ...
      function activate() {
         ...
         vm.salesData = [{ sales: 400 }, { sales: 800 }, { sales: 1200 }, { sales: 1400 }];
