...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/posts\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(334);
__webpack_require__(335);
//require('./public/src/js/abanner');
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/AllSchoolsController\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/AllClassroomsController\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/AllActivitiesController\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/ClassroomController\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/ClassroomSummaryController\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/ClassroomMessageController\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./public/app/controllers/dataViz\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
angular.module('app').component('about', {
  ...
  controller: 'aboutController', function: function _function() {
...
angular.module('app').component('maps', {
  ...
  controllerAs: 'mapsCtrl', function: function _function() {
...
dTech.factory("postService", function () {
	...
	return {
		...
		addToPost: function addToPost(book) {
			post.push(book);
			console.log(book);
		},
...
dTech.controller('TodoListController', function () {
	var todoList = this;
	todoList.todos = [{ text: 'Post One', done: true }, { text: 'Post Two', done: false }];
...
(function () {
   ...
   function registerController() {
      ...
      function activate() {
         vm.rOptions = {
            dataSource: {
               data: [{ name: "Login", id: 1 }, { name: "Register", id: 2 }, { name: "Verify Token", id: 3 }]
            },
            dataTextField: "name",
            dataValueField: "id",
...
(function () {
   ...
   angular.module('app').controller('dataEvents', [dataEvents]);
   ...
   function dataEvents() {
      ...
      function activate() {
         ...
         vm.cars = [{ year: 2012, make: "Ferrari", model: "California" }, { year: 2012, make: "Ferrari", model: "458 Italia" }, { year: 2012, make: "Lamborghini", model: "Aventador" }, { year: 2012, make: "Lamborghini", model: "Gallardo LP-570" }, { year: 2012, make: "Porsche", model: "911 GT3" }, { year: 2012, make: "McLaren", model: "MP14-12C" }, { year: 2012, make: "Koenigsegg", model: "CCX" }, { year: 1971, make: "Plymouth", model: "(Hemi) Barracuda" }, { year: 1967, make: "Ford", model: "Shelby Mustang GT500" }, { year: 1972, make: "Jaguar", model: "E-Type" }];

         vm.carsDataSource = new kendo.data.DataSource({ data: vm.cars,
            pageSize: 5,
            sort: { field: "year",
               dir: "asc" } });
         ...
         $("#cars").kendoGrid({
            ...
            columns: [{ field: "year", title: "Year" }, { field: "make", title: "Make" }, { field: "model", title: "Model" }, { command: ["edit"] }],
            pageable: true,
            scrollable: false,
            sortable: true,
            groupable: true,
         ...
         function makeData() {
            return [{ text: "Memory", items: [{ text: "Chips", items: [{ text: "8 GB DDR", checked: true }, { text: "8 GB DDR", checked: true }] }, { text: "Manufacturer", items: [{ text: "Acme Widgets", checked: true }, { text: "Foo Chips" }, { text: "Fish & Chips" }] }, { text: "Speed", items: [{ text: "100ms" }, { text: "500ms", checked: true }, { text: "1200ms" }] }] }, { text: "Storage", checked: true, items: [{ text: "Flash Drive", items: [{ text: "256 GB" }, { text: "500 GB" }, { text: "1 TB", checked: true }] }, { text: "Standard Drive", items: [{ text: "1 TB" }, { text: "2 TB" }, { text: "4 TB" }] }, { text: "External", items: [{ text: "1 TB USB" }, { text: "2 TB USB" }, { text: "8 TB Lightning", checked: true }] }] }, { text: "CD/DVD", items: [{ text: "CD", items: [{ text: "CD RO" }, { text: "CD RW" }, { text: "CD RWX" }] }, { text: "DVD", items: [{ text: "DVD RO" }, { text: "DVD RW" }, { text: "DVD RWX" }] }, { text: "Combo", items: [{ text: "R" }, { text: "RW" }, { text: "RWX" }] }] }];
         }
      }
   }
})();
...
(function () {
   ...
   function order($timeout) {
      ...
      vm.statusLabels = ["Validating order", "Validating credit", "Checking inventory", "Creating work order", "Finalizing work order", "Order entered"];
      vm.orderProgress = 0;
      ...
      function activate() {
         vm.computerOptions = {
            dataSource: {
               data: [{ name: "MacBook", id: 1001 }, { name: "MacBook Pro", id: 1010 }, { name: "Mac Mini", id: 2001 }, { name: "Mac Pro", id: 4010 }, { name: "iMac", id: 4050 }]
            },
            dataTextField: "name",
            dataValueField: "id",
