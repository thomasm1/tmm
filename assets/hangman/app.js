...
app.controller("GameController",['$scope','$timeout',function($scope,$timeout){
	var words=["Zebra","Remember","Mountain","Yoga", "MacBook", "Malificent", "Guessing", "Soccer","Android", "BLogging", "Guessing", "Thunder","Lightning", "Serendipity", "Pilates" ];
	...
	$scope.letterChosen = function() {
		...
		if($scope.displayWord.indexOf("*")==-1) {
			window.alert("You guessed right! ...   "+ $scope.displayWord);
			// Show score
			$timeout(function() {
				newGame();
			},1000);
