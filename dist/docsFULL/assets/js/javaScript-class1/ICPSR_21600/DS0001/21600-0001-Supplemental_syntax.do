/*-------------------------------------------------------------------------*
 ...
 |                           HEALTH), 1994-2008
 |                (DATASET 0001: WAVE 1, PUBLIC USE DATA)
 |
 |
...
replace H1HR7A = . if (H1HR7A >= 996 & H1HR7A <= 998)
...
replace H1HR7B = . if (H1HR7B >= 996 & H1HR7B <= 998)
...
replace H1MF2D = . if (H1MF2D == 7 | H1MF2D == 8)
...
replace H1EE4 = . if (H1EE4 == 996 | H1EE4 == 998 | H1EE4 == 999)
replace H1EE5 = . if (H1EE5 >= 996 & H1EE5 <= 999)
replace H1EE6 = . if (H1EE6 == 996 | H1EE6 == 998 | H1EE6 == 999)
replace H1EE7 = . if (H1EE7 >= 996 & H1EE7 <= 999)
...
replace H1WS5A = . if (H1WS5A >= 96 & H1WS5A <= 99)
