...
<div class="list-group list-group-lg">
    <a href="#" class="list-group-item animated fadeInDown bg-warning">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/images/people/13.png" alt="...">
      </span>
      <div>
    ...
    <a href="#" class="list-group-item ">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/images/people/1.png" alt="...">
      </span>
      <div>
        <h6 class="m-0">Thomas Maestas</h6>
    ...
    <a href="#" class="list-group-item">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/images/people/2.png" alt="...">
      </span>
      <div>
    ...
    <a href="#" class="list-group-item">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/images/people/3.png" alt="...">
      </span>
      <div>
        <h6 class="m-0">Michael Maestas</h6>
    ...
    <a href="#" class="list-group-item mb-n-md">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/images/people/14.png" alt="...">
      </span>
      <div>
        <h6 class="m-0">Victor Maestas</h6>
